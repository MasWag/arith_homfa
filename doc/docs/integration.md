...
- Provide static metadata (`signalSize`, `predicateSize`, and the `references` vector) so the runner knows how many CKKS slots to allocate and what error margins apply.
